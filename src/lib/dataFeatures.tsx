...
export const features = [
  {
    ...
    titleKey: "feat.employee",
    descriptionKey: "feat.db.desc",
    depthKey: "feat.db.depth",
  },
  {
    ...
    titleKey: "feat.payroll",
    descriptionKey: "feat.payroll.desc",
    depthKey: "feat.payroll.depth",
  },
  {
    ...
    titleKey: "feat.attendance",
    descriptionKey: "feat.att.desc",
    depthKey: "feat.att.depth",
  },
  {
    ...
    titleKey: "feat.leave",
    descriptionKey: "feat.leave.desc",
    depthKey: "feat.leave.depth",
  },
  {
    ...
    titleKey: "feat.performance",
    descriptionKey: "feat.perf.desc",
    depthKey: "feat.perf.depth",
  },
  {
    ...
    titleKey: "feat.training",
    descriptionKey: "feat.train.desc",
    depthKey: "feat.train.depth",
  },
  {
    ...
    titleKey: "feat.self services",
    descriptionKey: "feat.self.desc",
    depthKey: "feat.self.depth",
  },
  {
    ...
    titleKey: "feat.reporting",
    descriptionKey: "feat.report.desc",
    depthKey: "feat.report.depth",
  },
  {
    ...
    titleKey: "feat.secure",
    descriptionKey: "feat.secure.desc",
    depthKey: "feat.secure.depth",
  },
];
